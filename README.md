...
Resource-only plugin that bundles the **CIVA MacOS** keymap for all JetBrains
...
| `keymaps/CIVA MacOS.xml` | Keymap source of truth; copy into the plugin resources before building |
