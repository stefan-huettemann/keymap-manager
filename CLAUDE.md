...
- `Ä Ö Ü ß` are bindable via extended hex codes (`meta #10000d6` = ⌘Ö). Do not compute the codes by hand — `Ü` breaks the codepoint pattern; derive them from the JVM or an IDE-exported keymap (§4.4–4.5 of the handover).
